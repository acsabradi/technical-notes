...
export class PhoneBook<T extends IPerson>{ // a létrehozás során kell megmondani, hogy milyen típussal dogozzunk (extends)
    ...
    public get itemCnt() {return this.people.length;}

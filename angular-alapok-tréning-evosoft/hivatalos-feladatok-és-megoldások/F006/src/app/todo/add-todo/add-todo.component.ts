...
export class AddTodoComponent {
  ...
  save1(name : HTMLInputElement, prio : HTMLSelectElement){
    ...
    this.addItem.emit({priority: Object.values(Priority).indexOf(prio.value), name: name.value});
    // kitarakítom amezőt
    prio.value = 'low'
    name.value = '';
  }
